package com.strategair.strategy.common.image.implement

import android.widget.ImageView
import com.bumptech.glide.Priority
import com.bumptech.glide.load.resource.bitmap.BitmapTransitionOptions
import com.bumptech.glide.request.RequestOptions
import com.strategair.strategy.common.image.interfaces.IUserAvatar
...
object UserAvatar : IUserAvatar {
    ...
    @JvmStatic
    private val USER_AVATAR_OPTS = RequestOptions().priority(Priority.LOW)
        .centerCrop()
